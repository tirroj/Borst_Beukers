...
/**
 * presentation.Presentation houdt de slides in de presentatie bij.
 * <p>
 * In the presentation.Presentation's world, page numbers go from 0 to n-1 * <p>
 * This program is distributed under the terms of the accompanying
 * COPYRIGHT.txt file (which is NOT the GNU General Public License).
 * Please read it. Your use of the software constitutes acceptance
 * of the terms in the COPYRIGHT.txt file.
 * @author Ian F. Darwin, ian@darwinsys.com
 * @version $Id: presentation.Presentation.java,v 1.1 2002/12/17 Gert Florijn
 * @version $Id: presentation.Presentation.java,v 1.2 2003/11/19 Sylvia Stuurman
 * @version $Id: presentation.Presentation.java,v 1.3 2004/08/17 Sylvia Stuurman
 * @version $Id: presentation.Presentation.java,v 1.4 2007/07/16 Sylvia Stuurman
 */

public class Presentation {
  private String showTitle; // de titel van de presentatie
  private ArrayList<Slide> showList = null; // een ArrayList met de Slides
  private int currentSlideNumber = 0; // het slidenummer van de huidige presentation.Slide
